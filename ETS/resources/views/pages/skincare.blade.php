...
<header class="container topbar">
    ...
    <div class="search">
        <input type="text" id="searchInput" placeholder="Cari produk skincare..." aria-label="Search products" />
    </div>
    <div class="actions">
...
<section class="category-section">
    ...
    <div class="category-carousel" id="bestie">
        <div class="carousel" id="bestieCarousel">
            <div class="mini-card" onclick="openModal(10)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Water Bank Blue Hyaluronic Gel Moisturizer</p><p class="mini-price">Rp420.000</p></div></div>
            <div class="mini-card" onclick="openModal(11)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Barrier Repair Moisturizer</p><p class="mini-price">Rp450.000</p></div></div>
            <div class="mini-card" onclick="openModal(12)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Multi-Task Hyaluronic Serum</p><p class="mini-price">Rp420.000</p></div></div>
            <div class="mini-card" onclick="openModal(13)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Mighty Bamboo Panthenol Cream</p><p class="mini-price">Rp340.000</p></div></div>
            <div class="mini-card" onclick="openModal(14)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Midnight Recovery Concentrate</p><p class="mini-price">Rp660.000</p></div></div>
        </div>
    </div>

    <div class="category-carousel hidden" id="newbeauty">
        <div class="carousel" id="newbeautyCarousel">
            <div class="mini-card" onclick="openModal(15)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Resist Intensive Wrinkle Repair Retinol Serum</p><p class="mini-price">Rp550.000</p></div></div>
            <div class="mini-card" onclick="openModal(16)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Mineral Water Spray</p><p class="mini-price">Rp200.000</p></div></div>
            <div class="mini-card" onclick="openModal(17)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Just Breathe Clarifying Serum</p><p class="mini-price">Rp375.000</p></div></div>
            <div class="mini-card" onclick="openModal(18)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Daily UV Defence Sunscreen</p><p class="mini-price">Rp320.000</p></div></div>
            <div class="mini-card" onclick="openModal(19)"><div class="mini-image">Product</div><div class="mini-info"><p class="mini-name">Sensibio H2O Micellar Water</p><p class="mini-price">Rp260.000</p></div></div>
        </div>
    </div>
...
<section class="explore-section">
    <div class="explore-container">
        ...
        <div class="products-grid" id="exploreGrid">
            <!-- 20 produk -->
            <div class="explore-product-card" onclick="openModal(0)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Pure Cleansing Oil</div><div class="explore-product-price">Rp300.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(1)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">The Longevity Serum</div><div class="explore-product-price">Rp820.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(2)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Resveratrol Lift Serum</div><div class="explore-product-price">Rp650.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(3)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Mello Marula Cream Cleanser</div><div class="explore-product-price">Rp540.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(4)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Future Screen SPF50</div><div class="explore-product-price">Rp390.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(5)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Advanced Snail 96 Mucin Essence</div><div class="explore-product-price">Rp295.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(6)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Azelaic Acid Suspension 10%</div><div class="explore-product-price">Rp220.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(7)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Glycolic Fix Night Pads</div><div class="explore-product-price">Rp310.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(8)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Moisture Surge 100H Auto-Replenishing Hydrator</div><div class="explore-product-price">Rp480.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(9)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Galifornia Brightening Serum</div><div class="explore-product-price">Rp350.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(10)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Water Bank Blue Hyaluronic Gel Moisturizer</div><div class="explore-product-price">Rp420.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(11)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Barrier Repair Moisturizer</div><div class="explore-product-price">Rp450.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(12)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Multi-Task Hyaluronic Serum</div><div class="explore-product-price">Rp420.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(13)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Mighty Bamboo Panthenol Cream</div><div class="explore-product-price">Rp340.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(14)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Midnight Recovery Concentrate</div><div class="explore-product-price">Rp660.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(15)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Resist Intensive Wrinkle Repair Retinol Serum</div><div class="explore-product-price">Rp550.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(16)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Mineral Water Spray</div><div class="explore-product-price">Rp200.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(17)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Just Breathe Clarifying Serum</div><div class="explore-product-price">Rp375.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(18)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Daily UV Defence Sunscreen</div><div class="explore-product-price">Rp320.000</div></div></div>
            <div class="explore-product-card" onclick="openModal(19)"><div class="explore-product-image">Product</div><div class="explore-product-info"><div class="explore-product-badge">Skincare</div><div class="explore-product-name">Sensibio H2O Micellar Water</div><div class="explore-product-price">Rp260.000</div></div></div>
        </div>
    </div>
</section>
...
<script>
    const products = [
        {title:"Pure Cleansing Oil",brand:"Ma:nyo",price:300000,desc:"A Korean cleansing oil with 14 plant-based oils that effectively dissolves makeup, sunscreen, and impurities without stripping skin."},
        {title:"The Longevity Serum",brand:"Tatcha",price:820000,desc:"An anti-aging serum with a 10-peptide complex that promotes firmer, radiant, and youthful-looking skin."},
        {title:"Resveratrol Lift Serum",brand:"Caudalie",price:650000,desc:"A firming serum powered by resveratrol and grape polyphenols to smooth fine lines and lift the skin."},
        {title:"Mello Marula Cream Cleanser",brand:"Drunk Elephant",price:540000,desc:"A gentle cream cleanser infused with marula oil and essential fatty acids that cleanses thoroughly without stripping moisture."},
        {title:"Future Screen SPF50",brand:"Ultra Violette",price:390000,desc:"A tinted sunscreen that protects against UVA and UVB rays while evening out skin tone with a natural finish."},
        {title:"Advanced Snail 96 Mucin Essence",brand:"COSRX",price:295000,desc:"A lightweight essence with 96% snail mucin to repair damaged skin, improve texture, and boost elasticity."},
        {title:"Azelaic Acid Suspension 10%",brand:"The Ordinary",price:220000,desc:"A multifunctional brightening cream that reduces redness, evens out skin tone, and improves texture."},
        {title:"Glycolic Fix Night Pads",brand:"Nip + Fab",price:310000,desc:"Night exfoliating pads with glycolic and salicylic acids that remove dead skin cells and reveal smoother, glowing skin."},
        {title:"Moisture Surge 100H Auto-Replenishing Hydrator",brand:"Clinique",price:480000,desc:"A gel-cream moisturizer providing 100-hour hydration with auto-replenishing technology."},
        {title:"Galifornia Brightening Serum",brand:"Benefit Cosmetics",price:350000,desc:"A brightening serum infused with vitamins C and E to restore glow and even out skin tone."},
        {title:"Water Bank Blue Hyaluronic Gel Moisturizer",brand:"LANEIGE",price:420000,desc:"A refreshing gel moisturizer infused with Blue Hyaluronic Acid that deeply hydrates and strengthens the skin barrier."},
        {title:"Barrier Repair Moisturizer",brand:"Skintific",price:450000,desc:"A ceramide and peptide-rich moisturizer that repairs the skin barrier and soothes irritation."},
        {title:"Multi-Task Hyaluronic Serum",brand:"ILIA",price:420000,desc:"A clean, lightweight hyaluronic acid serum that deeply hydrates and preps the skin for makeup."},
        {title:"Mighty Bamboo Panthenol Cream",brand:"Purito",price:340000,desc:"A calming cream with bamboo extract and panthenol that hydrates and soothes sensitive or irritated skin."},
        {title:"Midnight Recovery Concentrate",brand:"Kiehl's",price:660000,desc:"An overnight facial oil with essential botanicals that visibly restores skin while you sleep."},
        {title:"Resist Intensive Wrinkle Repair Retinol Serum",brand:"Paula's Choice",price:550000,desc:"A retinol serum that targets wrinkles, fine lines, and uneven texture without causing irritation."},
        {title:"Mineral Water Spray",brand:"Evian",price:200000,desc:"A hydrating facial mist with pure mineral water to refresh and soothe the skin anytime."},
        {title:"Just Breathe Clarifying Serum",brand:"Versed",price:375000,desc:"An antioxidant-rich serum that rejuvenates dull skin and promotes overnight renewal."},
        {title:"Daily UV Defence Sunscreen",brand:"Innisfree",price:320000,desc:"A lightweight daily sunscreen with SPF50+ for effective UV protection without greasiness."},
        {title:"Sensibio H2O Micellar Water",brand:"Bioderma",price:260000,desc:"A gentle micellar cleanser that removes makeup and impurities while respecting sensitive skin."}
    ];
